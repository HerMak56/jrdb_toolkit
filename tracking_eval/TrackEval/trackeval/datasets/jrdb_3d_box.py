...
class JRDB3DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': os.path.join(code_path, 'data/gt/jrdb/jrdb_3d_box_train'),  # Location of GT data
            #'TRACKERS_FOLDER': os.path.join(code_path, 'data/trackers/jrdb/jrdb_3d_box_train/'),  # Trackers location
            # /pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/3dt/2021-10-28 12:10:45+00:00_ab3dmot2/
            #'TRACKERS_FOLDER': os.path.join(code_path, '/pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/3dt/2021-10-28 12:10:45+00:00_ab3dmot2/'),
            'TRACKERS_FOLDER': os.path.join(code_path, '/pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/3dt/2021-10-28 12:16:27+00:00_jrdb-jrmot2/'),
